...
import data.datasets.COCO2014_distill
import data.datasets.pazhou_distill_chatglm
...
if __name__ == "__main__":
    ...
    parser.add_argument("--datasize", type=str, default="10w", help="text data size")
